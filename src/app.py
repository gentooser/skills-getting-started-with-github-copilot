...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team drills, improve coordination, and compete in school games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Train endurance, technique, and racing skills in the pool",
    ...
    "Drama Club": {
        "description": "Build confidence through acting, improvisation, and stage performance",
    ...
    "Science Club": {
        "description": "Experiment, investigate, and explore exciting science topics",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Prevent duplicate registrations for the same student
